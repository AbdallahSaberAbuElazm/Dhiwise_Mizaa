import '../k58_page/widgets/k9_item_widget.dart';
...
class K58Page extends StatelessWidget {
  K58Page({Key? key})
      : super(
          key: key,
        );

  K58Controller controller = Get.put(K58Controller(K58Model().obs));
                                      ...
                                      child: Padding(
                                        ...
                                        child: Obx(
                                          () => ListView.builder(
                                            ...
                                            itemCount: controller.k58ModelObj
                                                .value.k9ItemList.value.length,
                                            itemBuilder: (context, index) {
                                              K9ItemModel model = controller
                                                  .k58ModelObj
                                                  .value
                                                  .k9ItemList
                                                  .value[index];
