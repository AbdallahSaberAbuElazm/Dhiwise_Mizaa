import '../one17_screen/widgets/chipviewgroup37_item_widget.dart';
...
class One17Screen extends GetWidget<One17Controller> {
  const One17Screen({Key? key})
      : super(
          key: key,
        );
            ...
            children: [
              Obx(
                () => Wrap(
                  ...
                  children: List<Widget>.generate(
                    controller.one17ModelObj.value.chipviewgroup37ItemList.value
                        .length,
                    (index) {
                      Chipviewgroup37ItemModel model = controller.one17ModelObj
                          .value.chipviewgroup37ItemList.value[index];

                      return Chipviewgroup37ItemWidget(
                        model,
                      );
                    },
                  ),
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                ...
                                CustomImageView(
                                  svgPath:
                                      ImageConstant.imgCheckmarkBlueGray20001,
                                  height: getVerticalSize(
                                    41,
                                  ),
                                  width: getHorizontalSize(
              ...
              Padding(
                ...
                child: Text(
                  ...
                  overflow: TextOverflow.ellipsis,
                  textAlign: TextAlign.left,
                  style: CustomTextStyles.titleSmallBluegray20001.copyWith(
                    letterSpacing: getHorizontalSize(
                      0.75,
                    ),
                  ),
