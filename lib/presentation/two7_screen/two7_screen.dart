import '../two7_screen/widgets/listrectangle1_item_widget.dart';
import '../two7_screen/widgets/listrectangle20_item_widget.dart';
import '../two7_screen/widgets/listrectangle21_item_widget.dart';
            ...
            child: SizedBox(
              ...
              child: Stack(
                ...
                children: [
                                    ...
                                    child: Obx(
                                      () => ListView.separated(
                                        ...
                                        itemCount: controller
                                            .two7ModelObj
                                            .value
                                            .listrectangle20ItemList
                                            .value
                                            .length,
                                        itemBuilder: (context, index) {
                                          Listrectangle20ItemModel model =
                                              controller
                                                  .two7ModelObj
                                                  .value
                                                  .listrectangle20ItemList
                                                  .value[index];
                                          return Listrectangle20ItemWidget(
                                            model,
                                          );
                                        },
                                      ),
                  ...
                  CustomImageView(
                    imagePath: ImageConstant.imgRectangle217116x34,
                    height: getVerticalSize(
                      116,
                    ),
                    width: getHorizontalSize(
                                    ...
                                    child: Obx(
                                      () => ListView.separated(
                                        ...
                                        itemCount: controller
                                            .two7ModelObj
                                            .value
                                            .listrectangle21ItemList
                                            .value
                                            .length,
                                        itemBuilder: (context, index) {
                                          Listrectangle21ItemModel model =
                                              controller
                                                  .two7ModelObj
                                                  .value
                                                  .listrectangle21ItemList
                                                  .value[index];
                                          return Listrectangle21ItemWidget(
                                            model,
                                          );
                                        },
                                      ),
