import '../k88_screen/widgets/k12_item_widget.dart';
...
class K88Screen extends GetWidget<K88Controller> {
  const K88Screen({Key? key})
      : super(
          key: key,
        );
                        ...
                        child: Obx(
                          () => ListView.builder(
                            ...
                            itemCount: controller
                                .k88ModelObj.value.k12ItemList.value.length,
                            itemBuilder: (context, index) {
                              K12ItemModel model = controller
                                  .k88ModelObj.value.k12ItemList.value[index];
                              return K12ItemWidget(
                                model,
                              );
                            },
                          ),
