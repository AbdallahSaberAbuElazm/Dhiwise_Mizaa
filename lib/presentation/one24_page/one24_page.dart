import '../one24_page/widgets/one4_item_widget.dart';
import 'controller/one24_controller.dart';
import 'models/one24_model.dart';
...
class One24Page extends StatelessWidget {
  One24Page({Key? key})
      : super(
          key: key,
        );

  One24Controller controller = Get.put(One24Controller(One24Model().obs));
                                    ...
                                    Align(
                                      ...
                                      child: Obx(
                                        () => ListView.separated(
                                          ...
                                          itemCount: controller.one24ModelObj
                                              .value.one4ItemList.value.length,
                                          itemBuilder: (context, index) {
                                            One4ItemModel model = controller
                                                .one24ModelObj
                                                .value
                                                .one4ItemList
                                                .value[index];
                                            return One4ItemWidget(
                                              model,
                                            );
                                          },
                                        ),
