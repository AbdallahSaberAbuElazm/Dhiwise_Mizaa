import '../two10_screen/widgets/k13_item_widget.dart';
                  ...
                  child: Obx(
                    () => ListView.separated(
                      ...
                      itemCount: controller
                          .two10ModelObj.value.k13ItemList.value.length,
                      itemBuilder: (context, index) {
                        K13ItemModel model = controller
                            .two10ModelObj.value.k13ItemList.value[index];
                        return K13ItemWidget(
                          model,
                        );
                      },
                    ),
