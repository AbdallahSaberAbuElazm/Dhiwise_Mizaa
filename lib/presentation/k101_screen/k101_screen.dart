import '../k101_screen/widgets/k15_item_widget.dart';
...
class K101Screen extends GetWidget<K101Controller> {
  const K101Screen({Key? key})
      : super(
          key: key,
        );
                  ...
                  child: Obx(
                    () => ListView.separated(
                      ...
                      itemCount: controller
                          .k101ModelObj.value.k15ItemList.value.length,
                      itemBuilder: (context, index) {
                        K15ItemModel model = controller
                            .k101ModelObj.value.k15ItemList.value[index];
                        return K15ItemWidget(
                          model,
                        );
                      },
                    ),
