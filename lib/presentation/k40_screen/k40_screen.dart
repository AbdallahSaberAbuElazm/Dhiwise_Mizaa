import '../k40_screen/widgets/listframe261_item_widget.dart';
import '../k40_screen/widgets/listframe581_item_widget.dart';
import 'controller/k40_controller.dart';
import 'models/listframe261_item_model.dart';
import 'models/listframe581_item_model.dart';
                      ...
                      child: Column(
                        ...
                        children: [
                              ...
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  child: Text(
                                    ...
                                    style: CustomTextStyles
                                        .labelLargeSecondaryContainerBold,
                                  ),
                                ),
                              ],
                            ),
                          ...
                          Padding(
                            ...
                            child: Obx(
                              () => ListView.separated(
                                ...
                                itemCount: controller.k40ModelObj.value
                                    .listframe261ItemList.value.length,
                                itemBuilder: (context, index) {
                                  Listframe261ItemModel model = controller
                                      .k40ModelObj
                                      .value
                                      .listframe261ItemList
                                      .value[index];
                                  return Listframe261ItemWidget(
                                    model,
                                  );
                                },
                              ),
                          ...
                          Padding(
                            ...
                            child: Obx(
                              () => ListView.separated(
                                ...
                                itemCount: controller.k40ModelObj.value
                                    .listframe581ItemList.value.length,
                                itemBuilder: (context, index) {
                                  Listframe581ItemModel model = controller
                                      .k40ModelObj
                                      .value
                                      .listframe581ItemList
                                      .value[index];
                                  return Listframe581ItemWidget(
                                    model,
                                  );
                                },
                              ),
                          ...
                          CustomFloatingButton(
                            ...
                            decoration:
                                FloatingButtonStyleHelper.fillPrimaryTL27,
                            child: CustomImageView(
                                      ...
                                      children: [
                                        CustomDropDown(
                                          ...
                                          textStyle: CustomTextStyles
                                              .labelMediumPrimary,
                                          items: controller.k40ModelObj.value
