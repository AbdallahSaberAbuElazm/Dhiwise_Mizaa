...
extension TextFormFieldStyleHelper on CustomTextFormField {
  ...
  static OutlineInputBorder get outlineBluegray800 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            12.00,
          ),
  ...
  static OutlineInputBorder get fillBluegray800 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            12.00,
          ),
  ...
  static OutlineInputBorder get fillBluegray50 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            12.00,
          ),
